            ...
            <div class="col-12 col-lg-4">
                <div class="creator-sec dd-bg">
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/1.png') }}" width="70" alt=""></div>
                    ...
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/2.png') }}" width="70" alt=""></div>
                        <div class="author-info">
                    ...
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/3.png') }}" width="70" alt=""></div>
                        <div class="author-info">
                    ...
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/4.png') }}" width="70" alt=""></div>
                        <div class="author-info">
            ...
            <div class="col-12 col-lg-4 mt-s">
                <div class="creator-sec dd-bg">
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/5.png') }}" width="70" alt=""></div>
                        <div class="author-info">
                            <a href="{{ url('/profile') }}"><h5 class="author-name">LarySmith-30</h5></a>
                            <p class="author-earn mb-0">647.34 ETH</p>
                        </div>
                    ...
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/6.png') }}" width="70" alt=""></div>
                        <div class="author-info">
                            <a href="{{ url('/profile') }}"><h5 class="author-name">Amillia Nnor</h5></a>
                            <p class="author-earn mb-0">521.85 ETH</p>
                        </div>
                    ...
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/7.png') }}" width="70" alt=""></div>
                        <div class="author-info">
                            <a href="{{ url('/profile') }}"><h5 class="author-name">Naretor-Nole</h5></a>
                            <p class="author-earn mb-0">511.45 ETH</p>
                        </div>
                    ...
                    <div class="author-item">
                        ...
                        <div class="author-img"><img src="{{ asset('img/authors/8.png') }}" width="70" alt=""></div>
                        <div class="author-info">
                            <a href="{{ url('/profile') }}"><h5 class="author-name">Johan Donem</h5></a>
                            <p class="author-earn mb-0">499.11 ETH</p>
                        </div>
